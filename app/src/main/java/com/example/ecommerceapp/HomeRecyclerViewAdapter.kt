...
class HomeRecyclerViewAdapter(private var productList: MutableList<Product>, private val context: Context) : RecyclerView.Adapter<HomeRecyclerViewAdapter.ProductViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        holder.productPriceTextView.text = "USD ${productList[position].productPrice}"
